...
```bash
grafana-cli --pluginUrl https://github.com/gapitio/gapit-htmlgraphics-panel/releases/download/v1.4.0/gapit-htmlgraphics-panel-1.4.0.zip plugins install gapit-htmlgraphics-panel
```
...
```bash
grafana-cli.exe --pluginUrl https://github.com/gapitio/gapit-htmlgraphics-panel/releases/download/v1.4.0/gapit-htmlgraphics-panel-1.4.0.zip plugins install gapit-htmlgraphics-panel
```
