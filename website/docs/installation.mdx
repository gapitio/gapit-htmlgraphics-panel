...
```bash
grafana-cli --pluginUrl https://github.com/gapitio/gapit-htmlgraphics-panel/releases/download/v1.3.3/gapit-htmlgraphics-panel-1.3.3.zip plugins install gapit-htmlgraphics-plugin
```
...
```bash
grafana-cli.exe --pluginUrl https://github.com/gapitio/gapit-htmlgraphics-panel/releases/download/v1.3.3/gapit-htmlgraphics-panel-1.3.3.zip plugins install gapit-htmlgraphics-plugin
```
...
services:
  grafana:
    ...
    ports:
      - 3000:3000
    environment:
      - GF_INSTALL_PLUGINS=https://github.com/gapitio/gapit-htmlgraphics-panel/releases/download/v1.3.3/gapit-htmlgraphics-panel-1.3.3.zip;gapit-htmlgraphics-panel # v1.3.3
