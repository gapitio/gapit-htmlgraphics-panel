...
The grafana directory could be somewhere else than written here. Please check <https://grafana.com/docs/grafana/latest/administration/configuration> to find where your grafana directory is located.
