...
<details>
<summary>The grafana dashboard payload for v2.0.0 (all the data, not just the saved panel options)</summary>
<div>
...
<details>
<summary>The grafana dashboard payload for version v1.5.0</summary>
<div>
